...
<div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <dl class="tw-grid tw-grid-cols-1 tw-gap-x-4 tw-gap-y-5 sm:tw-grid-cols-2">
                            ...
                            <div class="sm:tw-col-span-1 project-overview-billing" style="display:none;">
                                <dt class="tw-text-sm tw-font-medium tw-text-neutral-500">
                    ...
                    ?>
                            ...
                            <div class="sm:tw-col-span-1 project-overview-total-logged-hours" style="display:none;">
                                <dt class="tw-text-sm tw-font-medium tw-text-neutral-500">
    ...
    <div class="col-md-6 project-overview-right">
        ...
        <?php } ?>
        <div class="project-overview-timesheets-chart" style="display:none;">
	    ...
	    <div class="col-md-12">
		 ...
		 <div class="panel-body">
			...
			<div class="sm:tw-col-span-1 project-overview-description tc-content">
				...
				<dd class="tw-mt-1 tw-space-y-5 tw-text-sm tw-text-neutral-900">
					<img src="<?php echo base_url('uploads/property/'.$project->pro_image); ?>" alt="Property Image" />
