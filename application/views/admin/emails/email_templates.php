...
<div id="wrapper">
    <div class="content email-templates">
        <div class="row">
            <div class="col-md-12">
			   <div class="email_template_head" style=" display: flex; justify-content: space-between;    align-items: center;">
					<h4 class="tw-mt-0 tw-font-semibold tw-text-lg tw-text-neutral-700">
						<?php echo _l('email_templates'); ?>
					</h4>
					<div class="_buttons tw-mb-2 sm:tw-mb-4">
						 <a href="<?php echo admin_url('emails/add_new_template'); ?>" class="btn btn-primary pull-left display-block mright5"><i class="fa-regular fa-plus tw-mr-1"></i> New Template</a><div class="clearfix"></div>
					</div>
				</div>
                <div class="panel_s">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h4 class="tw-font-semibold email-template-heading">
                                    ...
                                    <a href="<?php echo admin_url('emails/disable_by_type/letters'); ?>"
                                        class="pull-right mleft5 mright25"><small><?php echo _l('disable_all'); ?></small></a>
                                    <a href="<?php echo admin_url('emails/enable_by_type/letters'); ?>"
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <?php foreach ($letters as $letters_template) { ?>
                                            <tr>
                                                <td class="<?php if ($letters_template['active'] == 0) {
    echo 'text-throught';
} ?>">
                                                    <a
                                                        href="<?php echo admin_url('emails/email_template/' . $letters_template['emailtemplateid']); ?>"><?php echo $letters_template['name']; ?></a>
                                                    <?php if (ENVIRONMENT !== 'production') { ?>
                                                    <br /><small><?php echo $letters_template['slug']; ?></small>
                                                    <?php } ?>
                                                    <?php if ($hasPermissionEdit) { ?>
													
													<a href="<?php echo admin_url('emails/email_delete/' . $letters_template['emailtemplateid']); ?>"
                                                        class="pull-right" style="margin-left:5px;color:red;"><small>Delete</small></a>
                                                    <a href="<?php echo admin_url('emails/' . ($letters_template['active'] == '1' ? 'disable/' : 'enable/') . $letters_template['emailtemplateid']); ?>"
                                                        class="pull-right"><small><?php echo _l($letters_template['active'] == 1 ? 'disable' : 'enable'); ?></small></a>
