    ...
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="_buttons">
                    <div class="row">
                        <div class="col-md-7 project-heading" style="display: flex;">
							...
							<a style=" margin-left: 10px; " href="<?php echo admin_url('projects/property_pdf/'.$project->id); ?>" target="_blank" class="btn btn-primary"> <i class="fa-solid fa-file-download tw-mr-1"></i> Download PDF</a>
                        </div>
...
<?php init_tail(); ?>
<!-- For invoices table -->
<!--script src="https://cdn.tiny.cloud/1/wu52qk7wtejxe1prlij0sre78uq5jghkpk73unz0d3yk2eev/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
<script>
	tinymce.init({
		selector: "#pro_letter",
	});
 ...
 $(document).ready(function(){
	  ...
	  $("#letteron").on('change',function(){
		...
		tinymce.activeEditor.setProgressState(false, 500)
		  var s='<?php echo $project->id; ?>';
		   var value=$(this).val();
			var frm = document.getElementById('letter11') || null;
			if(frm) {
			   frm.action =admin_url+'projects/letter_update/'+ value+'/'+ s; 
			}
