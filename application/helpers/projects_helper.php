...
function app_init_project_tabs()
{
    ...
    $CI->app_tabs->add_project_tab('project_gallery', [
        'name'                      => _l('Photo Gallery'),
        'icon'                      => 'fa fa-image',
        'view'                      => 'admin/projects/project_gallery',
        'position'                  => 65,
    ]);

    $CI->app_tabs->add_project_tab('project_floorplan', [
        'name'                      => _l('Floorplan'),
        'icon'                      => 'fa fa-building',
        'view'                      => 'admin/projects/project_floorplan',
        'position'                  => 70,
    ]);	

    $CI->app_tabs->add_project_tab('project_mapping', [
        'name'                      => _l('Map'),
        'icon'                      => 'fa fa-map',
        'view'                      => 'admin/projects/project_mapping',
        'position'                  => 75,
    ]);

    $CI->app_tabs->add_project_tab('project_letter', [
        'name'                      => _l('Letters'),
        'icon'                      => 'fa fa-edit',
        'view'                      => 'admin/projects/project_letter',
        'position'                  => 80,
    ]);
