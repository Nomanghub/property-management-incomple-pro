...
hooks()->add_action('admin_init', 'my_tenant_main_page');

function my_tenant_main_page(){
    $CI = &get_instance();

    $CI->app_menu->add_sidebar_menu_item('custom-menu-tenant-form', [
        'name'     => 'Tenants', // The name if the item
        'href'     => 'http://localhost/duke/admin/tenants', // URL of the item
